...
The strangest part was that some of the team members could boot the project without problems. After wildly commenting out most of the project's bootstrapping code we found out that the following lines were causing the crash:
