---
title: 'Using the k9s cli tool to get a clear overview and quick access to anything on your cluster'
date: '2023-12-05'
category: kubernetes
...
I find all the separate commands to figure out the status of your nodes, pods, logs and getting shell access to containers in different namespaces quite cumbersome. k9s solves all these issues by putting all the above at your fingertips. 
