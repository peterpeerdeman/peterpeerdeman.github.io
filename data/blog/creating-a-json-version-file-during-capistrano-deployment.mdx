...
I use the resulting version file to remotely retrieve the server's version for our status dashboard, which is pretty neat and gives you a quick overview of your servers' statuses.
