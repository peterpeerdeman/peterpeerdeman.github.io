...
As a future reference to myself, this is how we transformed iOS pem certificates into PFX packages for use with node's apn library

1. Use this guide by [Ray Wenderlich](https://www.raywenderlich.com/123862/push-notifications-tutorial) to create the push certificates
