...
Turns out there are a couple of packages missing that are needed, libicu72, libtextcat, libtextcat-data and liblua. Download and install them with the following commands:
```
...
After these modifications, you should be able to continue installation as documented
