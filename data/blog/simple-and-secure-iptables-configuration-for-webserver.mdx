...
Please note the incoming `RELATED,ESTABLISHED` line, which is necessary if you want to be able to create outgoing connections from the server. Without this line, all your CURLs and pings sent from the server will fail (as did mine before I added that line).
