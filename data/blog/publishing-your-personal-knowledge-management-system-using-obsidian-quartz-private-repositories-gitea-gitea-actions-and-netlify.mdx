...
- **Ease of use**: I want to use a single vault for both private and public files, as I've found that switching between vaults increases the barrier to publish
...
3. I connect my device to my home network using a VPN connection. Most modern routers support this feature nowadays, check the brand of your router and google something like `<brandname> <modelname> vpn guide`.
