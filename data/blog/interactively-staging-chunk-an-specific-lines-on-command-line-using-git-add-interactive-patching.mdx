...
As I'm trying to become less dependent on (otherwise excellent) visual git tools such as [sourcetree](https://www.sourcetreeapp.com/) or [fork](https://git-fork.com/) to work easily from within server environments, I ventured into the world of git commit crafting within the command line.
