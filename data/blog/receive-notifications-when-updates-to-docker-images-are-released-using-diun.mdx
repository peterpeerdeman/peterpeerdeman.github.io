...
category: technology
tags: ['docker', 'devops']
images: ['/assets/images/2023-05-05-diun.png']
---

When I would manually look through my `docker-compose.yml` files for regular server maintenance, I used to keep a browser tab with hub.docker.com open and manually check if there were new versions available. After doing this for the umpteenth time, I decided to look if there wasn't a way to get pro-actively notified when a new docker image is released.
