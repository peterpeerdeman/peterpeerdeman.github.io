...
category: devops
tags: ['devops']
images: ['/assets/images/2014-11-13-newrelic-01.png']
draft: false
---
...
New relic offers several libraries that can be included into your application code as well which allows even deeper inspection. We are using the node library integration that shows responsetimes for different endpoints, API throughput and an Apdex score based on your service's availability.
