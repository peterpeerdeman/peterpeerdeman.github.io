...
tags: ['agile']
images: ['/assets/images/2016-02-08-trello.png']
draft: false
---
...
One other thing this method lacks is a clear measurement of story point burn / charts. I found that keeping these kinds of graphs up to date is quite a task on top of the backlog management, which would be a thing to improve in the future.
