...
After being recommended like 100 times to give [Readwise](https://readwise.io) a try, Ernst Jan Pfauth finally convinced me during his talk about [thought dividends](https://notes.peterpeerdeman.nl/pkm-summit-2024#ernst-jan-pfauth---thought-dividends). And of course it was great: It is a well designed product with a rich featureset and it really supercharged my note making experience. 

But there was just something aching about incorporating a (quite costly) subscription product into the note making workflow that I want to keep indefinitely for the rest of my life. Currently at 15€ a month it is quite a luxury to splurge on.
...
We start by installing Wallabag and a database on our server using a docker compose yaml. Take special care to update the domain name, the ports (I'm using 3004) and the volume location.
