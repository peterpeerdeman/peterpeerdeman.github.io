...
As I was working on [my next python timeseries forecasting project using Darts](https://github.com/peterpeerdeman/darts-timeseries-forecaster), I found out darts doesn't quite like building its dependencies on the python slim image I was using in my Dockerfile.
