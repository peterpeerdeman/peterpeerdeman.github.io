...
category: devops
tags: ['timeseries', 'devops', 'observability']
images: ['/assets/images/2014-10-23-kibana.png']
draft: false
---

After hearing [Michael Heap's talk](http://endpointcon.com/posts/2014/07/01/michael-heap/) at Endpoint 2014 about doing more useful stuff with your logfiles I got inspired to start experimenting with big data: Elasticsearch, Logstash and Kibana.
