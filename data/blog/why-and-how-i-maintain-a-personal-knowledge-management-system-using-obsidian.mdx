...
- **Indexes / Maps of Content (MOC)**. There are legions of systems available to keep track of notes, I started with [a list of categories and topics](https://notes.peterpeerdeman.nl/), and tried linking each reference I added to at least one category or topic. Once the category and subcategories got too long, I [extracted them into their own index note](https://notes.peterpeerdeman.nl/Teder) 
...
- **Reviews**. I know you get sick and tired of being asked to write reviews for everything, but this time it is for you, and for you to form an opinion about something. Why did you like a book, movie, game or piece of music? What was it about that quote that stuck with you? I find that my "reviews" of source materials always start some interesting thoughts.
- **Recommendations**. Every time I get a recommendation for anything, I keep track of the recommendation, the type and the origin / person that recommended. Following up on recommendations with the people that recommended has resulted in some wonderful fruitful discussions and built far deeper relationships with people than only talking about the weather.
...
- **Learning, and Learning in Public**. Keeping notes on references while learning, and rewording knowledge in your own words is a great way to learn by itself. Sharing this reworded knowledge while you are learning in a blog used to be sometimes called "learner's journey blog", and can be a great way to process new material and get feedback from the outside world whilst you are still learning a new skill.
...
- **Tagging**. Don't sweat the structure too much, but for me using tags in todo's helps me keep separate todo lists for separate contexts. This avoids creating one big endless todo list you'll never get through, while still being able to capture TODO's that you want to follow up on some day.

Thanks for making it this far down the blog and I wish you a great journaling and knowledge management experience!
