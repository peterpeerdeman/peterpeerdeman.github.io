...
images: ['/assets/images/2020-05-20-parking.png']
draft: false
---
...
### public parking places in Amsterdam over time

![public parkingplaces in Amsterdam over time](../assets/images/2020-05-20-parking.png)

### [solar panel performance data with machine learning predictions](../blog/predicting-timeseries-data-using-facebook-prophet-in-a-python-flask-service-influxdb-and-grafana-on-raspberry-pi), based on pvoutput data

![solar panel performance data over time, based on pvoutput](../assets/images/2022-02-15-timeseries-prediction-review.png)
