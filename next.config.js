...
module.exports = withBundleAnalyzer({
    ...
    async redirects() {
        return [
            ...
            {
                source: '/devops/2014/04/16/simple-and-secure-iptables-configuration-for-webserver',
                destination: '/blog/simple-and-secure-iptables-configuration-for-webserver',
                permanent: true,
            },
            {
                source: '/technology/2014/03/31/my-thoughts-on-nosql-after-reading-a-book-about-it',
            ...
            {
                source: '/symfony2/2014/01/29/missing-label-translations-in-sonata-admin-interface',
